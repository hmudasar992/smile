...
const Footer = () => {
  return (
    <footer className="mb-6 md:mb-16 2xl:mb-32 mt-24 lg:mt-48">
      <div className="container mx-auto px-4 md:px-6">
        <div className="bg-[#FF6B6B] rounded-[24px] px-5 py-[70px] md:px-[70px] md:py-[90px] 2xl:px-[95px] 2xl:py-[100px]">
          <div className="flex flex flex-wrap-reverse lg:flex-nowrap">
            ...
            <div className="w-full lg:w-1/2">
              <div className="-mt-[180px] lg:-me-[80px] lg:-mt-[230px] lg:-mb-[160px]">
                <Image
